...
const Dashboard = () => {
  const [job, setJob] = useState("finance_manager");
    ...
    datasets: [
      {
        ...
        borderColor: "#1967d2",
        data: [2, 3, 3, 2, 1, 1, 0, 2, 2, 2, 1, 1, 2, 1, 2],
        fill: "start",
        tension: 0.4,
      },
    ],
  ...
  return (
    <Box display="flex" flexDirection="column" gap={4} mt={4}>
              ...
              <Grid item xs={6}>
                <Box display="flex" flexDirection="column" gap={1}>
                  ...
                  <Select
                    ...
                    fullWidth
                  >
                    <MenuItem key="finance_manager" value="finance_manager">
                      Fianace Manager
                    </MenuItem>
                    <MenuItem
                      key="social_media_maketing"
                      value="social_media_maketing"
                    >
                      Social Media Maketing
                    </MenuItem>
                    <MenuItem
                      key="senior_ui_ux_developer"
                      value="senior_ui_ux_developer"
                    >
      ...
      >
        ...
        <Divider />
        <Box display="flex">
          <TableContainer sx={{ padding: 4, paddingTop: 0 }}>
            <Table sx={{ minWidth: 650 }} aria-label="simple table">
              ...
              <TableBody>
                ...
                >
                  ...
                  <TableCell align="center">May 13, 2023</TableCell>
                  <TableCell align="center">
